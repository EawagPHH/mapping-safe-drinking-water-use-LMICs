...
source("./4_Training/feature_names/24_features.r")
source("./4_Training/feature_names/39_features.R")
source("./4_Training/feature_names/51_features.R")
source("./4_Training/feature_names/73_features.R")
source("./4_Training/feature_names/91_features.R")
source("./4_Training/feature_names/117_features.R")
...
```{r}
rf_predictions <- read.csv("./5_Prediction/prediction_results/100Bootstrap_SMDWPredictions.csv", fileEncoding = "UTF-8")
...
```{r}
JMP_SMDWs <- read.csv("switchdrive/Data_for_reviewers/JMP_2020_SMDWs_extracted.csv", encoding = "UTF-8") 
