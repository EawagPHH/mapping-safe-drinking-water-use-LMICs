...
source("~/GitHub/mapping-safe-drinking-water-use-LMICs/Training/feature_names/24_features.r")
source("~/GitHub/mapping-safe-drinking-water-use-LMICs/Training/feature_names/39_features.R")
source("~/GitHub/mapping-safe-drinking-water-use-LMICs/Training/feature_names/51_features.R")
source("~/GitHub/mapping-safe-drinking-water-use-LMICs/Training/feature_names/73_features.R")
source("~/GitHub/mapping-safe-drinking-water-use-LMICs/Training/feature_names/91_features.R")
source("~/GitHub/mapping-safe-drinking-water-use-LMICs/Training/feature_names/117_features.R")
...
#write.csv(rf.grid.perf@summary_table,"~/GitHub/mapping-safe-drinking-water-use-LMICs/Training/rf_grid_SMDW_reg_39.csv")
...
#write.csv(combined_SMDW_envir_regMatrix_39, "~/GitHub/mapping-safe-drinking-water-use-LMICs/Prediction/Regre_Matrix_SMDW.csv", fileEncoding = "UTF-8", row.names = T)
...
#write.csv(mean_SHAPvalues_SMDW, "~/GitHub/mapping-safe-drinking-water-use-LMICs/Prediction/prediction-results/Shap_values_SMDW_39_newest.csv", fileEncoding = "UTF-8", row.names = T)
...
rf_predictions$percentile75 <- apply(rf_predictions[,1:100],1, quantile, probs= 0.75)
 ...
 #write.csv(rf_predictions, "~/GitHub/mapping-safe-drinking-water-use-LMICs/Prediction/100Bootstrap_SMDWPredictions.csv", fileEncoding = "UTF-8", row.names = F) 
...
#write.csv(rf_predictions_IQR, "~/GitHub/mapping-safe-drinking-water-use-LMICs/Prediction/prediction-results/IQR_CoV_Mean_ofSMDWModels_newest.csv", fileEncoding = "UTF-8", row.names = F) 
...
```{r}
rf_predictions <- read.csv("~/GitHub/mapping-safe-drinking-water-use-LMICs/Prediction/prediction-results/100Bootstrap_SMDWPredictions.csv", fileEncoding = "UTF-8")
...
#write.csv(FullPrediction_SMDW_UNGlobalRegions,"~/GitHub/mapping-safe-drinking-water-use-LMICs/Prediction/prediction-results/SMDWPredictions_proportionAndNumberOfPeople_newest.csv") 
...
#write.csv(nationalpopulationSMDWcoverage_,"~/GitHub/mapping-safe-drinking-water-use-LMICs/Prediction/prediction-results/PredictionResultsNational_final_incl_mean_percentiles_newest.csv") 
```

##Comparing national estimates with JMP Data

```{r}
JMP_SMDWs <- read.csv("~/GitHub/mapping-safe-drinking-water-use-LMICs/Data/JMP_2020_SMDWs_extracted.csv", encoding = "UTF-8") 
...
#write.csv(nationalPredictions_JMP_SMDWs,"~/GitHub/mapping-safe-drinking-water-use-LMICs/Prediction/prediction-results/nationalPredictions_JMP_SMDWs_newest.csv") 
```
