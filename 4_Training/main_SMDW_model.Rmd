...
1)  random forest model with all 117 pre-selected features
...
2)  random forest model with 73 pre-selected features
...
3)  random forest model with 51 pre-selected features
...
4)  random forest model with 39 pre-selected features
...
5)  random forest model with 24 pre-selected features
...
Plot results from best RF Model for SMDWs Plot Predicted versus Observed SMDWs usage with results from leave-one-country-out holdout predictions.
