...
Ecoli_originalprediction <- read.csv( "./5_Predictions/prediction_results/Fullprediction_ecoli.csv", fileEncoding = "UTF-8")
...
Access_prediction <- read.csv( "./5_Prediction/prediction_results/Fullprediction_Access.csv", fileEncoding = "UTF-8")
...
Improved_prediction <- read.csv( "./5_Prediction/predition_results/Fullprediction_improved.csv", fileEncoding = "UTF-8")
