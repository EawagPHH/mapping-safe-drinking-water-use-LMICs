...
SMDW_Predictions <- read.csv( "./5_Predictions/prediction_results/SMDWPredictions_forTest.csv", fileEncoding = "UTF-8") %>% 
  select(predict.x, mean,GID_1, GID_0)

#Load and join population counts for 2020 to prediction data frame
Population_2020 <- read.csv("./1_Data/EnvironmentalFeatures/FeaturesAtGADMlevel1.csv", encoding = "UTF-8") %>% 
