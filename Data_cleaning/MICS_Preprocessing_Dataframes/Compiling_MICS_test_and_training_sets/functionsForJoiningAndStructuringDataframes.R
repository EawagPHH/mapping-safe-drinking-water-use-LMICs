...
readHouseHoldSurveyDataForTestSet <- function(){
  df.MICS_HH <- read.csv("~/GitHub/MICS_SMDW/Data_cleaning/MICS_Preprocessing_Dataframes/Compiling_MICS_test_and_training_sets/df_SMDW_test_final.csv", encoding = "UTF-8")
  return(df.MICS_HH)
}

readMatchedRegionNamesForTestSet <- function(){
  df.MICS_HH <- read.csv("~/GitHub/MICS_SMDW/Data_cleaning/MICS_Preprocessing_Dataframes/Compiling_MICS_test_and_training_sets/GADMandHH7_regionNamesForTestSet.csv", encoding = "UTF-8")
  return(df.MICS_HH)
}
...
readCountryIncomeGroup <- function(){
  countryIncomeGroup <- read.csv("~/GitHub/MICS_SMDW/Data/WorldBankIncomeGroup2020.csv", encoding = "UTF-8")
