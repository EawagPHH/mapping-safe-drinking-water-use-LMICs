...
#write.csv(df.MICS_envir_human_e.coli_39, "/Users/Esther/Documents/GitHub/MICS_SMDW/Prediction/Regre_Matrix_Ecoli.csv", fileEncoding = "UTF-8", row.names = F)
...
write.csv(rf_grid_perf_ecoli@summary_table,"~/GitHub/MICS_SMDW/Training/rf_grid_ecoli_reg_39.csv")
```
...
write.csv(mean_values_ecoli, "~/GitHub/MICS_SMDW/Prediction/Shap_values_ecoli.csv", fileEncoding = "UTF-8", row.names = T)
```
...
#write.csv(FullPrediction_ecoli, "~/GitHub/MICS_SMDW/Prediction/prediction-results/Fullprediction_Ecoli_newest.csv", fileEncoding = "UTF-8", row.names = F)
```
...
Ecoli_originalprediction <- read.csv( "~/GitHub/MICS_SMDW/Prediction/prediction-results/Fullprediction_ecoli.csv", fileEncoding = "UTF-8")
...
#write.csv(rf.grid.perf@summary_table,"~/GitHub/MICS_SMDW/Training/results_grid_search/rf_grid_Avail_reg_39_newest.csv")
...
#write.csv(mean_values_Avail, "~/GitHub/MICS_SMDW/Prediction/prediction_results/Shap_values_Avail_newest.csv", fileEncoding = "UTF-8", row.names = T)
...
#write.csv(FullPrediction_Avail, "~/GitHub/MICS_SMDW/Prediction/prediction_results/Fullprediction_Avail_newest.csv", fileEncoding = "UTF-8", row.names = F)
```
...
write.csv(combined_Access_envir_regMatrix_39 , "~/GitHub/MICS_SMDW/Prediction/Regre_Matrix_Access.csv", fileEncoding = "UTF-8", row.names = F)
...
#write.csv(rf_grid_perf_Access@summary_table,"~/GitHub/MICS_SMDW/Training/grid_search_results/rf_grid_Access_reg_39_newest.csv")
...
#write.csv(mean_values_Access, "~/GitHub/MICS_SMDW/Prediction/prediction_results/Shap_values_Access_newest.csv", fileEncoding = "UTF-8", row.names = T)
```
...
#write.csv(FullPrediction_Access, "~/GitHub/MICS_SMDW/Prediction/prediction_results/FullPrediction_Access_newest.csv", fileEncoding = "UTF-8", row.names = F)
```
##Descriptive analysis of accessibility results
```{r}
#source("~/GitHub/MICS_SMDW/Data_cleaning/MICS_Preprocessing_Dataframes/Compiling_MICS_test_and_training_sets/functionsForJoiningAndStructuringDataframes.R")

Access_prediction <- read.csv( "~/GitHub/MICS_SMDW/Prediction/prediction_results/Fullprediction_Access.csv", fileEncoding = "UTF-8")
...
#write.csv(rf_grid_perf_improved@summary_table,"~/GitHub/MICS_SMDW/Training/grid_search_results_rf_grid_improved_reg_39_newest.csv")
...
#write.csv(mean_values_Improved, "~/GitHub/MICS_SMDW/Prediction/predition_results/Shap_values_Improved_newest.csv", fileEncoding = "UTF-8", row.names = T)
```
...
#write.csv(FullPrediction_Improved, "~/GitHub/MICS_SMDW/Prediction/prediction_results/FullPrediction_Improved_newest.csv", fileEncoding = "UTF-8", row.names = F)
```
...
Improved_prediction <- read.csv( "~/GitHub/MICS_SMDW/Prediction/predition_results/Fullprediction_improved.csv", fileEncoding = "UTF-8")
